# RatFun-Regression
Fast and accurate single-parameter symbolic regression by <ul>rat</ul>ional function regression (Pade appliximants and reciprocal Padé approximants). Rational functions have the following form:
